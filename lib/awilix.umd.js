    ...
    function createContainer(options, parentContainer) {
        ...
        function resolve(name, resolveOpts) {
            ...
            try {
                ...
                var resolverEntry = computedRegistrations[name];
                ...
                var resolver = resolverEntry.resolver;
                // get the container the resolver was registered to for the SCOPED_SINGLETON lifetime.
                var registeredContainer = resolverEntry.container;
                ...
                switch (resolver.lifetime || Lifetime.TRANSIENT) {
                    ...
                    case Lifetime.SCOPED_SINGLETON:
                        ...
                        for (var _i = 0, familyTree_1 = familyTree; _i < familyTree_1.length; _i++) {
                            var searchContainer = familyTree_1[_i];
                        ...
                        resolved = resolver.resolve(container);
                        registeredContainer.cache.set(name, { resolver: resolver, value: resolved });
                        break;
                    default:
